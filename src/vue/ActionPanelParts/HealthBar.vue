...
const styleVars = computed(() => ({
  '--blood-border-middle': bloodBorderMiddleSrc,
  '--blood-bar': bloodBarSrc,
}));
...
<template>
  <div class="health-bar" :style="styleVars" aria-label="Health Bar">
...
<style scoped src="../../styles/health-bar.css"></style>
