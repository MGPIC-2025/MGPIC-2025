...
// 铜偶仓库：资源与铜偶数据（响应式）
const resources = ref([
  { icon: '/assets/img/warehouse/goods/2ec8cf838cb33e421005058d17ff555b82cebf83.png', name: '蓝晶', value: 88 },
  { icon: '/assets/img/warehouse/goods/04681f25cc1debaf94214a7e09f44efbc7eb2963.png', name: '木箱', value: 88 },
  { icon: '/assets/img/warehouse/goods/1331f319af1e23fc301b7253ca5dca71e9c19e0f.png', name: '紫球', value: 88 },
  { icon: '/assets/img/warehouse/goods/ea74bce606c59ac4ab84ab117375c0de813cea49.png', name: '蓝片', value: 88 }
])
...
const puppets = ref([
  { 
    ...
    name: '阿磐01', 
    level: 1, 
    image: '/assets/img/warehouse/character/a93e15a01fcbf3cfb088956aedc63e86b94d4019.png', 
    quantity: 1,
    ...
    equipment: [
      { name: '钢盾', icon: '/assets/img/warehouse/equip/3579e09f8cf4063c7d94f9f1d1a6db6fe746923f.png', equipped: true },
    ...
    skill: {
      ...
      icon: '/assets/img/warehouse/skill/9ae9fd092931138c37c47a30f463011e7f4301d8.png'
    },
    upgradeCost: 10
  },
  { 
    ...
    name: '卫斯理01', 
    level: 1, 
    image: '/assets/img/warehouse/character/b2207275b74545d9fae68b985b2998de3672e0af.png', 
    quantity: 1,
    ...
    equipment: [
      { name: '合金锅', icon: '/assets/img/warehouse/equip/3579e09f8cf4063c7d94f9f1d1a6db6fe746923f.png', equipped: true },
      { name: '空槽', icon: '🔒', equipped: false }
    ],
    skill: {
      name: '锅炉过热',
      ...
      icon: '/assets/img/warehouse/skill/7b7cb41dbb1b9dae0bc4e7d030386f6d7d2e7da0.png'
    },
    upgradeCost: 10
  }
])
  ...
  <div class="warehouse">
        ...
        <div v-if="selectedPuppet" class="puppet-detail">
          ...
          <div class="puppet-detail__upgrade">
            <div class="upgrade-cost">
              <img class="cost-icon-img" src="/assets/img/warehouse/goods/ea74bce606c59ac4ab84ab117375c0de813cea49.png" alt="cost" />
    ...
    <div v-if="showDrawScreen" class="draw-screen">
      <div class="draw-screen__body">
        <div class="draw-card">
          <img class="draw-card__img" src="/assets/img/warehouse/goods/04681f25cc1debaf94214a7e09f44efbc7eb2963.png" alt="card" />
        </div>
        <div class="draw-cost">
          <img class="draw-cost__icon" src="/assets/img/warehouse/goods/ea74bce606c59ac4ab84ab117375c0de813cea49.png" alt="cost" />
