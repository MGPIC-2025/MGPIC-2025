...
- [ ] 添加特色房间遭遇战设计，例如：
  ...
  | 遭遇名称 | 敌人组合 | 战术特色 | 资源倾向 | 难度等级 |
  | --- |  --- |  --- |  --- |  --- |
  | 机械巡逻队 | 齿轮斥候×2 + 蒸汽拳手×1 | 高速突击 | 回响齿轮 | 中等 |
  | 魔法乐团 | 管风琴号手×2 + 镜面编织者×1 | 远程压制 | 共鸣星晶 | 中等 |
  | 刺客小队 | 发条刺客×3 | 高闪避突击 | 均衡 | 高 |
  | 重装防线 | 锈蚀巡游者×2 + 巨锤守卫×1 | 防御推进 | 防御资源 | 高 |
  | 计算阵列 | 差分机妖×2 + 齿轮斥候×2 | 精准打击 | 计算资源 | 极高 |
  | 欢宴派对 | 心源畸变体×1 + 哥布林×4 | 范围混乱 | 心源资源 | 高 |
  | BOSS战 | 织网夫人 + 镜像分身×2 | 战术控制 | 全面资源 | BOSS |
  | 最终决战 | 废械吞噬者 + 锅炉吞噬者×2 | 生存消耗 | 高额资源 | BOSS |

- [ ] 为部分高阶敌人和boss添加特色机制，例如：

  | 敌人名称 | 等级 | 特殊能力 | 特色描述 |
  | --- |  --- |  --- |  --- |
  | 巨锤守卫 | 5 | **震荡打击**：攻击有20%概率眩晕目标1回合 | 终极防御者，移动缓慢但坚不可摧 |
  | 差分机妖 | 5 | **最优计算**：每回合选择最优攻击目标，无视50%防御 | 高速计算核心，精准打击弱点 |
  | 心源畸变体 | 5 | **欢宴感染**：使最近的一个目标无法移动/攻击1回合（有CD） | 范围混乱大师，制造战场混乱 |
  | 织网夫人-夏特拉 | 6 | **网络操控**：每3回合召唤2个镜像分身（健康50，攻击20） | 战术大师，通过分身控制战场 |
  | 废械吞噬者-饕餮 | 6 | **金属吞噬**：每回合恢复7.5%生命值 | 移动堡垒，通过持续恢复消耗对手 |
